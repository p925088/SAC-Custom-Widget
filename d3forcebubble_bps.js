		...
		<form id="form">
			<table style="width: 100%;">
				<tr>
					<td>
						<div>Data: </div>
						<div><textarea id="bps_data" style="min-height: 150px;width: 100%;">[{"name":"Buenos Aires","size":85084, "color":50, "xvalue":100},{"name":"Córdoba","size":330876, "color":10, "xvalue":20}]</textarea></div>
						<div><button id="bps_data_submit">Set Data</button></div>
					</td>
				</tr>
				<tr>
					<td>X-Axis label: <input id="bps_xAxisLabel" type="text"></td>
				</tr>
				<tr>
					<td>Size-Axis label: <input id="bps_sizeLabel" type="text"></td>
				</tr>
				<tr>
					<td>Color-Axis label: <input id="bps_colorLabel" type="text"></td>
				</tr>
				<tr>
					<td>Decimal place of value on x-axis: <input id="bps_valDecimal" type="number" step=1 min=0 max=5></td>
				</tr>
				<tr>
					<td>Decimal place of value on size-axis: <input id="bps_sizeDecimal" type="number" step=1 min=0 max=5></td>
				</tr>
				<tr>
					<td>Decimal place of value on color-axis: <input id="bps_colorDecimal" type="number" step=1 min=0 max=5></td>
				</tr>
			</table>
