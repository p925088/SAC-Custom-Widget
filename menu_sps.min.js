(function() {
    ...
    template.innerHTML = `<form id="form"><table><tr><td><input id="sps_showGroupHeader" type="checkbox" checked> Show Group Header in Sub-Menu<br/></td></tr><tr><td><div><b>Define Colors:</b></div><div>Menu-bar background: <input id="sps_menuBackgroundColor" type="color" value="#cccccc"><br/>Menu-bar font: <input id="sps_menuFontColor" type="color" value="#4b4b4b"></div></td></tr></table><input type="submit" style="display:none;"></form>`;
