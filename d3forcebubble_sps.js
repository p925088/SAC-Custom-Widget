(function() {
	...
	template.innerHTML = `
		<form id="form">
			<table>
				<tr>
					<td>Title: <input id="sps_title" type="text" value="Custom Force Bubble Widget"></td>
				</tr>
				<tr>
					<td><input id="sps_showTitle" type="checkbox" checked>Show Title</td>
				</tr>
				<tr>
					<td><input id="sps_showAvg" type="checkbox" checked>Show Average Line</td>
				</tr>
				<tr>
					<td>
						<div><b> Define Color Scale </b></div>
						<div>
							Start color: <input id="sps_startColor" type="color" value="#ffcd00">
							<br/>
							End color: <input id="sps_endColor" type="color" value="#b01c02">
						</div>
					</td>
				</tr>
			</table>
	...
	class FBUBBLE_Sps extends HTMLElement {
		constructor() {
			...
			//this._shadowRoot.getElementById("sps_title").addEventListener("input", this._formSubmit.bind(this));
		}
