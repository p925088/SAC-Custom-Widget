...
(function() {
    ...
    class MENU extends HTMLElement {
        ...
        drawChart(_menudata, config) {
            ...
            var menu = drawMenu(_menudata, config, this.shadowRoot, this);
        }
        ...
        drawMenu(dataJSON, config, root, eventDispatcher) {
        	...
        	for(var i=0; i<dataJSON.length; i++){
        		...
        		const anchornode = node.append('a').attr("id", dataJSON[i].id);
        		anchornode.text(dataJSON[i].label);        		
        		...
        		const _submenu = dataJSON[i].value;
        		if(_submenu.length > 1 && _submenu != undefined){
        			...
        			for(var j=0; j<_submenu.length; j++){
        				...
        				sanchornode.on('click', function (d){
        					console.log(d.srcElement.innerText);
        					console.log(d.srcElement.id);
        					updateSelection(d.srcElement.innerText, d.srcElement.id);
        				});
